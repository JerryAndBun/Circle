    ...
    <div class="usermain">
      <div class="userinfo">
        <div class="nickname">
          ...
          <div class="lv">&nbsplv17&nbsp正式会员&nbsp</div>
        </div>
        <div class="sign">
          <div class="coversitiondiv"></div>
          <img class="useravatar" :src="`${baseurl}${itemList.avatar}`" />
          <p>{{ itemList.signature }}</p>
        </div>
        <div class="followdiv">
          <p class="follow">{{ itemList.focusOn }}</p>
          <br />
          <p href="" class="followedlink">关注</p>
        </div>
        <div class="fansdiv">
          <p class="fans">{{ itemList.fans }}</p>
          <br />
          <p href="" class="fanslink">粉丝</p>
        </div>
        <div class="manuscriptdiv">
          <p class="manuscript">{{ itemList.videos }}</p>
          <br />
