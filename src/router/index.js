  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'fanslist',
          component: () => import('../components/FansList'),
        },
        {
          path: 'setting',
          ...
          children: [
            ...
            },
            {
              ...
              component: () => import('../components/AccountSecurity.vue'),
            },
          ],
        },
      ],
    },
    {
      ...
      children: [
        ...
        {
          path: 'video',
          component: () => import('../components/VideoResult.vue'),
        },
        {
          path: 'user',
          component: () => import('../components/UserResult.vue'),
        },
      ],
    },
    {
      ...
      children: [
        {
          path: ':uid',
          name: 'window',
          component: () => import('../components/MessageWindow.vue'),
        },
      ],
    },
    {
      path: '/contribution',
      component: () => import('../pages/Contribution.vue'),
    },
    {
      path: '/video',
