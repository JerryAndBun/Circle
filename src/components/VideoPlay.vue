    ...
    <div class="allcontainer" ref="videocontainer" id="videocontainer">
      <div class="left_container">
        ...
        >
          ...
          <div
            ...
            ref="controls_container"
            @mouseenter="mouse_in_contrl"
            @mouseleave="mouse_out_contrl"
          >
            <div
              class="progress"
              ref="progress"
            ...
            >
              ...
              <div
                class="played"
                ref="played"
                :style="{ width: video_play_Item.percent * 100 + '%' }"
              >
                <div class="progress_dotdiv" ref="progress_dotdiv"></div>
              </div>
            </div>
            <div class="left_area">
              ...
              <div class="timer_ange">
                <span class="played_h played" v-if="is_more_hour">{{
                  video_play_Item.played_h
                }}</span>
                ...
                <span>/</span>
                <span class="duration_h duration" v-if="is_more_hour">{{
                  video_play_Item.duration_h
                }}</span>
                <span v-if="is_more_hour">:</span>
            ...
            <div class="right_area">
              <div class="volume" @mouseenter="show_volume_panel" @mouseleave="hide_volume_panel">
                <div class="volume_panel" ref="volume_panel">
                  <el-slider v-model="volume_value" vertical height="60px"> </el-slider>
                </div>
              ...
              <div class="fullscreenbtn" ref="fullscreen_btn" @click="fullscreenchange">
                <i
                  class="iconfont"
                  :class="fullscreened ? 'icon-tuichuquanping' : 'icon-quanping'"
                ></i>
              </div>
            </div>
          </div>
        ...
        <div class="footer_bar">
          ...
          <div class="footer_mindiv">
            <i
              ...
              :class="is_collected ? 'active' : 'unactive'"
              @click="collect_video"
            ></i
            >{{ video_item.collects }}
          </div>
        ...
        <div class="description_container" ref="description_container">
          ...
          <div class="clickformore" ref="clickformore" @click="unfold" v-if="clickformore">
            展开更多
          </div>
        </div>
        <div class="tagList_container">
          <ul class="tagList">
            <li v-for="(item, index) in video_item.tags" :key="index">
        ...
        <div class="comment_list_container">
          <CommentDiv
            v-for="(item, index) in video_comments"
            ref="CommentDiv"
            :key="index"
      ...
      <div class="right_container">
        <div class="info_container">
          <img
            class="auth_avatar"
            :src="`${baseurl}${auth_info.avatar}`"
            @click="to_this_userpage"
          />
          <div class="info_div">
            ...
            <div
              class="foucus_btn"
              ref="foucus_btn"
              :class="auth_info.isFocusOn ? 'focused' : 'unfocus'"
              @click="send_focus_request"
            >
              +&nbsp关注
            </div>
          </div>
        ...
        <div class="recommond_container">
          ...
          <VideoPreview
            class="VideoPreview"
            v-for="(item, index) in recommond_list"
            :key="index"
            :video_item="item"
          >
...
export default {
  ...
  methods: {
    ...
    forwardSuccess() {
      this.$store.commit('info/toast_list', {
        action: 'push',
        message: '转发成功',
        type: 'success',
      })
    ...
    get_new_timerange() {
      ...
      this.video_play_Item.played_m = this.fill_zero(
        2,
        Math.floor((this.video_play_Item.currentTime - this.video_play_Item.played_h * 3600) / 60)
      )
      this.video_play_Item.played_s = this.fill_zero(
        2,
        Math.floor(
          this.video_play_Item.currentTime -
            (this.video_play_Item.played_h * 3600 + this.video_play_Item.played_m * 60)
        )
      )
    },
    init_video() {
      ...
      this.video_play_Item.duration_m = this.fill_zero(
        2,
        Math.floor((this.video_play_Item.duration - this.video_play_Item.duration_h * 3600) / 60)
      )
      this.video_play_Item.duration_s = this.fill_zero(
        2,
        Math.floor(
          this.video_play_Item.duration -
            (this.video_play_Item.duration_h * 3600 + this.video_play_Item.duration_m * 60)
        )
      )
    },
    video_playing() {},
